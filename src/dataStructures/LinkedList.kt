...
import dataStructures.exceptions.LinkedListEmptyException
...
class LinkedList {
    ...
    fun reverse() {
        var currentNode = head ?: throw LinkedListEmptyException()
        //if the linked list has one node it already reversed
        if (currentNode.next == null) {
            return
        }
        var nextNode = currentNode.next
        //make the head the new tail
        currentNode.next = null
        while (nextNode?.next != null) {
            val theNextNode = nextNode.next
